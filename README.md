...
| Bereich | Rolle / Projekt | Link / Beschreibung |
| :--- | :--- | :--- |
| **Web-Anwendung** | Autohaus Kleinjena | [autohaus-kleinjena.netlify.app](https://autohaus-kleinjena.netlify.app/) – Digitales Fahrzeugportal mit modernem Schaufenster &amp; Filterung. *(Erstellt von Emin)* |
| **Public Sector Web** | FIM Schulung | [fim-schulung.de](https://fim-schulung.de/) – E-Learning &amp; Wissensportal im Öffentlichen Sektor. *(Mit Kollegin verbessert)* |
| **Falcos GmbH** | Softwareentwickler | Entwicklung automatisierter XÖV-ZUGFeRD Parser zur Reduzierung manueller Erfassungszeiten in Behörden. |
| **SIDUM e.V.** | Finanzen & Recht | Mitarbeit an Kreditentscheidungs-Use-Cases (d-fine) &amp; PwC GenAI Masterclass. |
...
* **[Autohaus Kleinjena](https://autohaus-kleinjena.netlify.app/)** – Digital car dealership web portal featuring inventory search, service booking, and responsive UI. *(Created by Emin Girimhanov)*
* **[FIM Schulung](https://fim-schulung.de/)** – E-Learning and training platform for Federal Information Management in the public sector. *(Improved with a colleague)*
